...
- Strong baselines: RecBole SASRec/BERT4Rec/GRU4Rec/LightGCN now route through TRUCE candidate scoring/import/evaluation. MovieLens 1M and Amazon Beauty have completed TRUCE-evaluated rows. Amazon Video Games RecBole rows were not run and are not claimed as passed.
