...
The RecBole external-baseline adapter now exports canonical TRUCE data, trains SASRec/BERT4Rec/LightGCN, scores the shared TRUCE candidate sets, imports predictions into the TRUCE schema, and evaluates with the TRUCE evaluator. MovieLens 1M completed end to end on CPU: SASRec reached Recall@10 0.184934, NDCG@10 0.108555, MRR@10 0.085336; BERT4Rec reached Recall@10 0.199172, NDCG@10 0.107392, MRR@10 0.079387; LightGCN reached Recall@10 0.212086, NDCG@10 0.107865, MRR@10 0.076519. Amazon Beauty completed end to end on CPU after a clean rerun: SASRec reached Recall@10 0.013333, NDCG@10 0.005158, MRR@10 0.002667; BERT4Rec and LightGCN reached 0.000000 on all three metrics under the current adapter/config.
