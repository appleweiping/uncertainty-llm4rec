...
- SASRec, BERT4Rec, GRU4Rec, and LightGCN have adapter/config/export/train/score/import support and TRUCE-evaluated rows for MovieLens 1M and Amazon Beauty. Amazon Video Games strong baselines were not run in this stage.
