...
$ValidLog = Join-Path $SummaryDir "day29_movies_medium5_2000_valid_inference.log"
$ValidErr = Join-Path $SummaryDir "day29_movies_medium5_2000_valid_inference.err.log"
...
if ($validRows -lt 12000) {
    Run-Inference "valid" $ValidLog $ValidErr
    $validRows = Count-Lines $ValidRaw
}
if ($validRows -ne 12000) {
    throw "Valid inference incomplete: $validRows / 12000"
}
...
"Day29 Movies medium_5neg_2000 pipeline completed." | Add-Content $AnalysisLog
