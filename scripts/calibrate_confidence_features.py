"""Fit/apply the split-audited CURE/TRUCE calibration scaffold."""
...
def _default_output_dir(features_jsonl: Path) -> Path:
    try:
        ...
        return ROOT / "outputs" / "confidence_calibration" / relative_parent
    except ValueError:
        return ROOT / "outputs" / "confidence_calibration" / features_jsonl.stem
...
def main(argv: list[str] | None = None) -> int:
    ...
    output_jsonl = (
        ...
        else output_dir / "calibrated_features.jsonl"
    )
    manifest_json = (
