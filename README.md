...
- the first Week7 server-backend handoff: unified local-HF backend wiring, Qwen3-8B ModelScope-local model config, smoke experiment configs, server workflow docs, and a recoverable batch registry for local-HF smoke runs
